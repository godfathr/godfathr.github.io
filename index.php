...
?>
                    ...
                    <div class="col-md-6 text-left">
                        <div class="panel">
							...
							<div class="panel-body">
								...
								<p id="moreNutshell">
									My interest in development lives in every layer of the .NET stack. From Web Forms to WPF to MVC, my desire is to create unique and intuitive applications for
						...
						<div class="col-md-6 text-left">
							<div class="panel">
								...
								<div class="panel-body">
									<p>
										While my prodcuts looks pretty and function well, I never treat application security as an afterthought. I always place a very
    ...
    <script>
        $(document).ready(function () {
            ...
            $('body').scrollspy({ target: "#scrollNav", offset: 60 });
        ...
        $('.container .body-content').scrollspy({ target: "#scrollNav", offset: 60 });
